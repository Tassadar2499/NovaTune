...
## Remaining Work / Gaps
- Frontend automated tests are not yet evidenced by committed spec/test files
...
- Frontend: implemented at the route/page/store level, but still less mature operationally than the backend
