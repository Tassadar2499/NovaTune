...
try
{
    ...
    // ============================================================================
    // Storage Service (for physical deletion)
    // ============================================================================
    ...
    builder.Services.AddSingleton<PhysicalDeletionMetrics>();
    ...
    // ============================================================================
    // Health Checks (Physical Deletion)
    // ============================================================================
    builder.Services.AddHealthChecks()
        .AddCheck<PhysicalDeletionHealthCheck>("physical-deletion");
...
internal class KafkaFlowHostedService : BackgroundService
{
    ...
    {
        _logger.LogInformation("Starting Lifecycle Worker KafkaFlow bus...");
